    ...
    <div className="chapter">
      ...
      <div className="space-y-10">
        <section>
          ...
          <Card className="p-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-xl border border-slate-700">
        ...
        <section>
          ...
          <Card className="p-6 mb-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-xl border border-slate-700">
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-100">
              ...
              <li>
                Upon successful verification through the <code className="bg-slate-700 px-1 rounded">help</code> protocol and LLM-based inverted index reasoning, 
                developers receive an <strong className="text-indigo-200">initial grant</strong> calculated as:
              </li>
            </ul>
            
            <div className="bg-slate-700 p-4 my-4 rounded-md text-center">
          ...
          <Card className="p-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-xl border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-blue-900/70 p-5 rounded-lg shadow-md border border-blue-700">
              ...
              <div className="bg-green-900/70 p-5 rounded-lg shadow-md border border-green-700">
              ...
              <div className="bg-purple-900/70 p-5 rounded-lg shadow-md border border-purple-700">
              ...
              <div className="bg-amber-900/70 p-5 rounded-lg shadow-md border border-amber-700">
            ...
            <div className="mt-6 bg-indigo-900/70 p-5 rounded-lg shadow-md border border-indigo-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-slate-100">
                  Staking is not only a participation threshold but also a critical factor for incentive rewards (denoted as <code className="bg-slate-700 px-1 rounded">κ</code>), 
        ...
        <section>
          ...
          <Card className="p-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-xl border border-slate-700">
            ...
            <div className="bg-slate-700 p-5 rounded-lg shadow-md mb-6 border border-slate-600">
            ...
            <div className="bg-slate-700 p-5 rounded-lg shadow-md mb-6 border border-slate-600">
              ...
              <div className="bg-slate-800 p-4 my-4 rounded-md text-center">
            ...
            <div className="bg-slate-700 p-5 rounded-lg shadow-md border border-slate-600">
        ...
        <section>
          ...
          <Card className="p-6 bg-gradient-to-r from-slate-800 to-slate-900 text-white shadow-xl border border-slate-700">
            <ul className="list-disc pl-5 space-y-3 text-slate-100">
              <li><strong className="text-teal-300">Native Token:</strong> <code className="bg-slate-700 px-2 py-1 rounded text-yellow-300">{"$AIO"}</code></li>
              <li>
                <strong className="text-teal-300">Incentive Rules:</strong>
                <ul className="list-disc pl-5 mt-2 space-y-2 text-slate-100">
                  <li>Agents are required to stake <code className="bg-slate-700 px-1 rounded text-yellow-300">{"$AIO"}</code> in order to register and operate within the AIO network.</li>
                  <li>
